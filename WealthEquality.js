...
// The year is 2088 and the Radical Marxist Socialist People's Party (RMSPP) has just seized power in 
// Brazil.
...
function redistributeWealth(wealth) {
    let avg = wealth.reduce((a,c) => a+c) / wealth.length;
    wealth = wealth.fill(avg, 0);
}