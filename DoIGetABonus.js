...
// Build a function that takes in two arguments (salary, bonus). Salary will be an integer, and bonus 
// a boolean.
...
// Go, Java and Julia), "$" (C#, C++, Ruby, Clojure, Elixir, PHP, Python, Haskell and Lua) or "¥" (Rust).
