...
// For the sake of simplicity, you can assume that any numbers passed into the function will correspond 
// to vowels.

function encode(string) {
    const vowels = ['a', 'e', 'i', 'o', 'u'];
    return [...string].map(e => vowels.includes(e) ? vowels.indexOf(e)+1 : e).join('');
  }
  
  function decode(string) {
    const vowels = ['a', 'e', 'i', 'o', 'u'];
    return [...string].map(e => parseInt(e, 10) ? vowels[e-1] : e).join('');
}